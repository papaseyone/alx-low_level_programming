...
/**
 * sorted_list - funct for insert new node in sorted
...
/**
 * shash_table_set - funct that adds element to the sorted hash table
 * @ht: pointer to sorted hash table
...
/**
 * shash_table_get - funct to retrieve value associated with key
...
/**
 * shash_table_print - funct to print key:value from ht
 * @ht: pointer to hash table
 *
 */
...
/**
 * shash_table_print_rev - funct to print key:value from ht in reverse
 * @ht: pointer to hash table
 *
 */
